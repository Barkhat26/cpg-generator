...
from graphs.ast.abstract_syntax_tree import AbstractSyntaxTree, AbstractSyntaxTreeNX
...
<table border="0" cellborder="0" cellspacing="1">
    ...
    def exportGraphML(self, filename="default"):
        G = nx.DiGraph()
        for idx, n in enumerate(self.nodes):
            G.add_node(id(n), label=n.kind.name, code=str(n.getCode()), ctxId=str(n.shared_id))
