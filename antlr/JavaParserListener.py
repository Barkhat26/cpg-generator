# Generated from F:/Workspace/CPG-Creator/antlr\JavaParser.g4 by ANTLR 4.8
from antlr4 import *
...
class JavaParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JavaParser#StmtBlock.
    def enterStmtBlock(self, ctx:JavaParser.StmtBlockContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtBlock.
    def exitStmtBlock(self, ctx:JavaParser.StmtBlockContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtAssert.
    def enterStmtAssert(self, ctx:JavaParser.StmtAssertContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtAssert.
    def exitStmtAssert(self, ctx:JavaParser.StmtAssertContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtIf.
    def enterStmtIf(self, ctx:JavaParser.StmtIfContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtIf.
    def exitStmtIf(self, ctx:JavaParser.StmtIfContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtFor.
    def enterStmtFor(self, ctx:JavaParser.StmtForContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtFor.
    def exitStmtFor(self, ctx:JavaParser.StmtForContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtWhile.
    def enterStmtWhile(self, ctx:JavaParser.StmtWhileContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtWhile.
    def exitStmtWhile(self, ctx:JavaParser.StmtWhileContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtDoWhile.
    def enterStmtDoWhile(self, ctx:JavaParser.StmtDoWhileContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtDoWhile.
    def exitStmtDoWhile(self, ctx:JavaParser.StmtDoWhileContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtTry.
    def enterStmtTry(self, ctx:JavaParser.StmtTryContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtTry.
    def exitStmtTry(self, ctx:JavaParser.StmtTryContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtTryResource.
    def enterStmtTryResource(self, ctx:JavaParser.StmtTryResourceContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtTryResource.
    def exitStmtTryResource(self, ctx:JavaParser.StmtTryResourceContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtSwitch.
    def enterStmtSwitch(self, ctx:JavaParser.StmtSwitchContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtSwitch.
    def exitStmtSwitch(self, ctx:JavaParser.StmtSwitchContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtSynchronized.
    def enterStmtSynchronized(self, ctx:JavaParser.StmtSynchronizedContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtSynchronized.
    def exitStmtSynchronized(self, ctx:JavaParser.StmtSynchronizedContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtReturn.
    def enterStmtReturn(self, ctx:JavaParser.StmtReturnContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtReturn.
    def exitStmtReturn(self, ctx:JavaParser.StmtReturnContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtThrow.
    def enterStmtThrow(self, ctx:JavaParser.StmtThrowContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtThrow.
    def exitStmtThrow(self, ctx:JavaParser.StmtThrowContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtBreak.
    def enterStmtBreak(self, ctx:JavaParser.StmtBreakContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtBreak.
    def exitStmtBreak(self, ctx:JavaParser.StmtBreakContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtContinue.
    def enterStmtContinue(self, ctx:JavaParser.StmtContinueContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtContinue.
    def exitStmtContinue(self, ctx:JavaParser.StmtContinueContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtSemi.
    def enterStmtSemi(self, ctx:JavaParser.StmtSemiContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtSemi.
    def exitStmtSemi(self, ctx:JavaParser.StmtSemiContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtExpr.
    def enterStmtExpr(self, ctx:JavaParser.StmtExprContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtExpr.
    def exitStmtExpr(self, ctx:JavaParser.StmtExprContext):
        pass


    # Enter a parse tree produced by JavaParser#StmtLabel.
    def enterStmtLabel(self, ctx:JavaParser.StmtLabelContext):
        pass

    # Exit a parse tree produced by JavaParser#StmtLabel.
    def exitStmtLabel(self, ctx:JavaParser.StmtLabelContext):
        pass
    ...
    # Enter a parse tree produced by JavaParser#ExprMulDivMod.
    def enterExprMulDivMod(self, ctx:JavaParser.ExprMulDivModContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprMulDivMod.
    def exitExprMulDivMod(self, ctx:JavaParser.ExprMulDivModContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprComparison.
    def enterExprComparison(self, ctx:JavaParser.ExprComparisonContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprComparison.
    def exitExprComparison(self, ctx:JavaParser.ExprComparisonContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprBitXor.
    def enterExprBitXor(self, ctx:JavaParser.ExprBitXorContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprBitXor.
    def exitExprBitXor(self, ctx:JavaParser.ExprBitXorContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprDot.
    def enterExprDot(self, ctx:JavaParser.ExprDotContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprDot.
    def exitExprDot(self, ctx:JavaParser.ExprDotContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprPostUnaryOp.
    def enterExprPostUnaryOp(self, ctx:JavaParser.ExprPostUnaryOpContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprPostUnaryOp.
    def exitExprPostUnaryOp(self, ctx:JavaParser.ExprPostUnaryOpContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprBitShift.
    def enterExprBitShift(self, ctx:JavaParser.ExprBitShiftContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprBitShift.
    def exitExprBitShift(self, ctx:JavaParser.ExprBitShiftContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprMethodRef3.
    def enterExprMethodRef3(self, ctx:JavaParser.ExprMethodRef3Context):
        pass

    # Exit a parse tree produced by JavaParser#ExprMethodRef3.
    def exitExprMethodRef3(self, ctx:JavaParser.ExprMethodRef3Context):
        pass


    # Enter a parse tree produced by JavaParser#ExprMethodRef2.
    def enterExprMethodRef2(self, ctx:JavaParser.ExprMethodRef2Context):
        pass

    # Exit a parse tree produced by JavaParser#ExprMethodRef2.
    def exitExprMethodRef2(self, ctx:JavaParser.ExprMethodRef2Context):
        pass


    # Enter a parse tree produced by JavaParser#ExprArray.
    def enterExprArray(self, ctx:JavaParser.ExprArrayContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprArray.
    def exitExprArray(self, ctx:JavaParser.ExprArrayContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprMethodRef1.
    def enterExprMethodRef1(self, ctx:JavaParser.ExprMethodRef1Context):
        pass

    # Exit a parse tree produced by JavaParser#ExprMethodRef1.
    def exitExprMethodRef1(self, ctx:JavaParser.ExprMethodRef1Context):
        pass


    # Enter a parse tree produced by JavaParser#ExprPrimary.
    def enterExprPrimary(self, ctx:JavaParser.ExprPrimaryContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprPrimary.
    def exitExprPrimary(self, ctx:JavaParser.ExprPrimaryContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprAddSub.
    def enterExprAddSub(self, ctx:JavaParser.ExprAddSubContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprAddSub.
    def exitExprAddSub(self, ctx:JavaParser.ExprAddSubContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprPrePreUnaryOp.
    def enterExprPrePreUnaryOp(self, ctx:JavaParser.ExprPrePreUnaryOpContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprPrePreUnaryOp.
    def exitExprPrePreUnaryOp(self, ctx:JavaParser.ExprPrePreUnaryOpContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprLogicAnd.
    def enterExprLogicAnd(self, ctx:JavaParser.ExprLogicAndContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprLogicAnd.
    def exitExprLogicAnd(self, ctx:JavaParser.ExprLogicAndContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprInstanceOf.
    def enterExprInstanceOf(self, ctx:JavaParser.ExprInstanceOfContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprInstanceOf.
    def exitExprInstanceOf(self, ctx:JavaParser.ExprInstanceOfContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprEquality.
    def enterExprEquality(self, ctx:JavaParser.ExprEqualityContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprEquality.
    def exitExprEquality(self, ctx:JavaParser.ExprEqualityContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprLambda.
    def enterExprLambda(self, ctx:JavaParser.ExprLambdaContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprLambda.
    def exitExprLambda(self, ctx:JavaParser.ExprLambdaContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprMethodCall.
    def enterExprMethodCall(self, ctx:JavaParser.ExprMethodCallContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprMethodCall.
    def exitExprMethodCall(self, ctx:JavaParser.ExprMethodCallContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprTernary.
    def enterExprTernary(self, ctx:JavaParser.ExprTernaryContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprTernary.
    def exitExprTernary(self, ctx:JavaParser.ExprTernaryContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprNegation.
    def enterExprNegation(self, ctx:JavaParser.ExprNegationContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprNegation.
    def exitExprNegation(self, ctx:JavaParser.ExprNegationContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprLogicOr.
    def enterExprLogicOr(self, ctx:JavaParser.ExprLogicOrContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprLogicOr.
    def exitExprLogicOr(self, ctx:JavaParser.ExprLogicOrContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprBitOr.
    def enterExprBitOr(self, ctx:JavaParser.ExprBitOrContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprBitOr.
    def exitExprBitOr(self, ctx:JavaParser.ExprBitOrContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprCasting.
    def enterExprCasting(self, ctx:JavaParser.ExprCastingContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprCasting.
    def exitExprCasting(self, ctx:JavaParser.ExprCastingContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprNew.
    def enterExprNew(self, ctx:JavaParser.ExprNewContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprNew.
    def exitExprNew(self, ctx:JavaParser.ExprNewContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprBitAnd.
    def enterExprBitAnd(self, ctx:JavaParser.ExprBitAndContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprBitAnd.
    def exitExprBitAnd(self, ctx:JavaParser.ExprBitAndContext):
        pass


    # Enter a parse tree produced by JavaParser#ExprAssign.
    def enterExprAssign(self, ctx:JavaParser.ExprAssignContext):
        pass

    # Exit a parse tree produced by JavaParser#ExprAssign.
    def exitExprAssign(self, ctx:JavaParser.ExprAssignContext):
        pass
