...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by JavaParser#StmtBlock.
    def visitStmtBlock(self, ctx:JavaParser.StmtBlockContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtAssert.
    def visitStmtAssert(self, ctx:JavaParser.StmtAssertContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtIf.
    def visitStmtIf(self, ctx:JavaParser.StmtIfContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtFor.
    def visitStmtFor(self, ctx:JavaParser.StmtForContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtWhile.
    def visitStmtWhile(self, ctx:JavaParser.StmtWhileContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtDoWhile.
    def visitStmtDoWhile(self, ctx:JavaParser.StmtDoWhileContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtTry.
    def visitStmtTry(self, ctx:JavaParser.StmtTryContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtTryResource.
    def visitStmtTryResource(self, ctx:JavaParser.StmtTryResourceContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtSwitch.
    def visitStmtSwitch(self, ctx:JavaParser.StmtSwitchContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtSynchronized.
    def visitStmtSynchronized(self, ctx:JavaParser.StmtSynchronizedContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtReturn.
    def visitStmtReturn(self, ctx:JavaParser.StmtReturnContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtThrow.
    def visitStmtThrow(self, ctx:JavaParser.StmtThrowContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtBreak.
    def visitStmtBreak(self, ctx:JavaParser.StmtBreakContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtContinue.
    def visitStmtContinue(self, ctx:JavaParser.StmtContinueContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtSemi.
    def visitStmtSemi(self, ctx:JavaParser.StmtSemiContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtExpr.
    def visitStmtExpr(self, ctx:JavaParser.StmtExprContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#StmtLabel.
    ...
    # Visit a parse tree produced by JavaParser#ExprMulDivMod.
    def visitExprMulDivMod(self, ctx:JavaParser.ExprMulDivModContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprComparison.
    def visitExprComparison(self, ctx:JavaParser.ExprComparisonContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprBitXor.
    def visitExprBitXor(self, ctx:JavaParser.ExprBitXorContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprDot.
    def visitExprDot(self, ctx:JavaParser.ExprDotContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprPostUnaryOp.
    def visitExprPostUnaryOp(self, ctx:JavaParser.ExprPostUnaryOpContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprBitShift.
    def visitExprBitShift(self, ctx:JavaParser.ExprBitShiftContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprMethodRef3.
    def visitExprMethodRef3(self, ctx:JavaParser.ExprMethodRef3Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprMethodRef2.
    def visitExprMethodRef2(self, ctx:JavaParser.ExprMethodRef2Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprArray.
    def visitExprArray(self, ctx:JavaParser.ExprArrayContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprMethodRef1.
    def visitExprMethodRef1(self, ctx:JavaParser.ExprMethodRef1Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprPrimary.
    def visitExprPrimary(self, ctx:JavaParser.ExprPrimaryContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprAddSub.
    def visitExprAddSub(self, ctx:JavaParser.ExprAddSubContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprPrePreUnaryOp.
    def visitExprPrePreUnaryOp(self, ctx:JavaParser.ExprPrePreUnaryOpContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprLogicAnd.
    def visitExprLogicAnd(self, ctx:JavaParser.ExprLogicAndContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprInstanceOf.
    def visitExprInstanceOf(self, ctx:JavaParser.ExprInstanceOfContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprEquality.
    def visitExprEquality(self, ctx:JavaParser.ExprEqualityContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprLambda.
    def visitExprLambda(self, ctx:JavaParser.ExprLambdaContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprMethodCall.
    def visitExprMethodCall(self, ctx:JavaParser.ExprMethodCallContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprTernary.
    def visitExprTernary(self, ctx:JavaParser.ExprTernaryContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprNegation.
    def visitExprNegation(self, ctx:JavaParser.ExprNegationContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprLogicOr.
    def visitExprLogicOr(self, ctx:JavaParser.ExprLogicOrContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprBitOr.
    def visitExprBitOr(self, ctx:JavaParser.ExprBitOrContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprCasting.
    def visitExprCasting(self, ctx:JavaParser.ExprCastingContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprNew.
    def visitExprNew(self, ctx:JavaParser.ExprNewContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprBitAnd.
    def visitExprBitAnd(self, ctx:JavaParser.ExprBitAndContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#ExprAssign.
